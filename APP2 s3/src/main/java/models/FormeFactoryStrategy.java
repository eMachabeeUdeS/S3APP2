...
//class FormeFactoryEnergy, class FormeFactoryInversion, class FormeFactoryModel, class Carre, interface Forme and
//interface FormeFactory.

public class FormeFactoryStrategy implements FormeFactory {
